...
import { copyFolderRecursiveSync, deleteWithPrompt, } from "../utils/fs-utils.js";
import { fileURLToPath } from "url";
import { readFile } from "fs/promises";
const constants = JSON.parse(await readFile(new URL("../init/constants.json", import.meta.url)));
...
async function run(folder, update, next, y) {
    ...
    if (next)
        await patchForNextRelease(folder, y);
}
async function patchForNextRelease(folder, y) {
    print("===== updating project file and directory structure for next version =====");
